...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="relative flex h-screen animate-fade items-center justify-center p-4 text-zinc-100">
        ...
        <div className="glass relative w-full max-w-md animate-pop-in overflow-hidden rounded-2xl border-red-500/25 p-6 text-center shadow-[0_0_80px_rgba(239,68,68,0.12)]">
          ...
          />
          <div className="mx-auto mb-4 grid h-9 w-9 place-items-center rounded-xl bg-red-500/15 text-red-400 ring-1 ring-inset ring-red-500/20">
          ...
          <h2 className="mb-1 text-sm font-semibold text-zinc-100">Algo deu errado</h2>
          <p className="mb-5 text-xs text-zinc-500">um componente falhou ao renderizar</p>
          <button
            onClick={() => location.reload()}
            className="rounded-xl bg-gradient-to-r from-cyan-500 to-violet-500 px-5 py-2.5 text-sm font-medium text-white shadow-lg shadow-cyan-500/10 transition-all duration-200 hover:scale-[1.03] hover:shadow-[0_0_24px_rgba(34,211,238,0.35)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/70 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 active:scale-95"
          >
            Reload
          </button>
        </div>
