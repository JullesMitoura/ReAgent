...
- A denied call means the user declined it: do not retry the same action verbatim. Adjust your approach, choose a different path, or ask the user what they would prefer.`;
